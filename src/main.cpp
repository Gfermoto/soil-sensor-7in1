...
void setup()
{
    ...
    // ИСПРАВЛЕН URL - используем конкретную версию вместо /latest/
    setupOTA("https://github.com/Gfermoto/soil-sensor-7in1/releases/download/v3.1.1/manifest.json", otaClient);
