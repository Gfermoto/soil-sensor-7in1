...
struct PageInfo
{
   ...
   private:
    PageInfo(const String& title, const String& icon)
        : title(title), icon(icon) {}  // NOLINT(bugprone-easily-swappable-parameters)
   public:
    ...
    struct Builder
    {
        String title;
        String icon;
        Builder& setTitle(const String& titleText)
        {
            title = titleText;
            return *this;
        }
        Builder& setIcon(const String& iconText)
        {
            icon = iconText;
            return *this;
        }
...
struct FormInfo
{
   ...
   private:
    FormInfo(const String& action, const String& method, const String& formContent, const String& buttonText,
             const String& buttonIcon)  // NOLINT(bugprone-easily-swappable-parameters)
   ...
   public:
    ...
    struct Builder
    {
        ...
        String buttonText;
        String buttonIcon;
        Builder& setAction(const String& actionUrl)
        {
            action = actionUrl;
            return *this;
        }
        Builder& setMethod(const String& methodType)
        {
            method = methodType;
            return *this;
        }
        Builder& setFormContent(const String& content)
        {
            formContent = content;
            return *this;
        }
        Builder& setButtonText(const String& text)
        {
            buttonText = text;
            return *this;
        }
        Builder& setButtonIcon(const String& icon)
        {
            buttonIcon = icon;
            return *this;
        }
...
struct InputFieldInfo
{
   ...
   private:
    InputFieldInfo(const String& fieldId, const String& fieldName, const String& fieldLabel, const String& fieldValue,
                   const String& fieldType, bool fieldRequired,
                   const String& fieldPlaceholder)  // NOLINT(bugprone-easily-swappable-parameters)
        : id(fieldId),
          name(fieldName),
          label(fieldLabel),
          value(fieldValue),
   ...
   public:
    ...
    struct Builder
    {
        ...
        bool required = false;
        String placeholder;
        Builder& setId(const String& fieldIdValue)
        {
            id = fieldIdValue;
            return *this;
        }
        Builder& setName(const String& fieldName)
        {
            name = fieldName;
            return *this;
        }
        Builder& setLabel(const String& labelText)
        {
            label = labelText;
            return *this;
        }
        Builder& setValue(const String& valueText)
        {
            value = valueText;
            return *this;
        }
        Builder& setType(const String& typeText)
        {
            type = typeText;
            return *this;
        }
        Builder& setRequired(bool isRequired)
        {
            required = isRequired;
            return *this;
        }
        Builder& setPlaceholder(const String& placeholderText)
        {
...
struct NumberFieldInfo
{
   ...
   private:
    NumberFieldInfo(const String& fieldId, const String& fieldName, const String& fieldLabel, int fieldValue,
                    int fieldMin, int fieldMax, int fieldStep)  // NOLINT(bugprone-easily-swappable-parameters)
        : id(fieldId),
          name(fieldName),
          label(fieldLabel),
          value(fieldValue),
   ...
   public:
    ...
    struct Builder
    {
        ...
        Builder& setValue(int valueNum)
        {
            value = valueNum;
            return *this;
        }
        Builder& setMin(int minNum)
        {
            min = minNum;
            return *this;
        }
        Builder& setMax(int maxNum)
        {
            max = maxNum;
            return *this;
        }
        Builder& setStep(int stepNum)
        {
            step = stepNum;
            return *this;
        }
...
struct ConfigSectionInfo
{
   ...
   private:
    ConfigSectionInfo(const String& title, const String& content,
                      const String& helpText)  // NOLINT(bugprone-easily-swappable-parameters)
   ...
   public:
    ...
    struct Builder
    {
        ...
        Builder& setContent(const String& contentText)
        {
            content = contentText;
            return *this;
        }
        Builder& setHelpText(const String& helpTextValue)
        {
...
// Глобальные функции
String generatePageHeader(
    const String& titleText,
    const String& iconText)  // NOLINT(bugprone-easily-swappable-parameters,misc-use-internal-linkage)
{
    return generatePageHeaderImpl(PageInfo::builder().setTitle(titleText).setIcon(iconText).build());
}

String
generatePageFooter()  // NOLINT(misc-use-internal-linkage,readability-convert-member-functions-to-static,misc-use-anonymous-namespace)
{
    return "</div>" + String(getToastHTML()) + "</body></html>";
}

String generateBasePage(
    const String& titleText, const String& contentText,
    const String& iconText)  // NOLINT(bugprone-easily-swappable-parameters,misc-use-internal-linkage)
{
...
String generateErrorPage(
    int errorCode,
    const String& errorMessage)  // NOLINT(bugprone-easily-swappable-parameters,misc-use-internal-linkage)
{
...
String generateSuccessPage(
    const String& titleText, const String& messageText,
    const String& redirectUrlText,  // NOLINT(bugprone-easily-swappable-parameters,misc-use-internal-linkage)
...
String generateApModeUnavailablePage(
    const String& titleText,
    const String& iconText)  // NOLINT(bugprone-easily-swappable-parameters,misc-use-internal-linkage)
{
