...
static constexpr float k_t_N[3] = {0.0041f, 0.0038f, 0.0032f};
static constexpr float k_t_P[3] = {0.0053f, 0.0049f, 0.0042f};
static constexpr float k_t_K[3] = {0.0032f, 0.0029f, 0.0024f};
...
static inline float k_h_P(float th){ return 1.6f - 0.018f*th; }
static inline float k_h_K(float th){ return 1.9f - 0.021f*th; }
