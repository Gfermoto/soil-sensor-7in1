...
void test_validation_ssid_length()
{
    ...
    std::cout << "✅ Валидация SSID: короткий=" << ssid_short.length() << ", длинный=" << ssid_long.length()
              << std::endl;
}
...
void test_validation_password_strength()
{
    ...
    std::cout << "✅ Валидация пароля: слабый=" << weak.length() << ", сильный=" << strong.length() << std::endl;
}
...
void test_validation_temperature_range()
{
    ...
    std::cout << "✅ Валидация температуры: низкая=" << temp_low << ", нормальная=" << temp_normal
              << ", высокая=" << temp_high << std::endl;
}
...
void test_config_default_values()
{
    ...
    std::cout << "✅ Конфигурация по умолчанию: MQTT=" << config.mqtt_port << ", Web=" << config.web_port
              << ", Name=" << config.device_name << std::endl;
}
...
void test_config_validation()
{
    ...
    std::cout << "✅ Валидация конфигурации: валидный порт=" << valid_port << ", невалидный=" << invalid_port
              << std::endl;
}
