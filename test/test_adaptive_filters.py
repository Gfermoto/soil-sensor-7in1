...
def test_outlier_detection():
    ...
    # Расширенный тест с достаточным количеством данных для статистики
    normal_values = [25.0, 25.1, 25.2, 25.0, 25.1, 24.9, 25.3, 25.0, 25.2, 25.1]
    outlier_value = 100.0
...
def test_kalman_filter():
    ...
    # Простая симуляция с документацией параметров
    measurements = [25.0, 25.5, 24.8, 26.0, 25.2]
    Q, R, P = 0.1, 1.0, 1.0  # Q: process noise, R: measurement noise, P: initial uncertainty
    x = measurements[0]
