...
- **Unit тесты:** 50 Google Test + 8 Unity + 8 CSRF
...
1. **Native тесты исключены** из метрик технического долга
2. **Фокус на ESP32** - основная платформа разработки
3. **Windows-проблемы** не влияют на качество кода
4. **Безопасность превыше всего** - CSRF защита реализована

---

**Обновлено:** 30.06.2025 - добавлены Windows-ограничения
