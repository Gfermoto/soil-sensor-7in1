...
<div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  ...
  <ul style="margin: 10px 0; padding-left: 20px;">
    <li><a href="html/manuals/USER_GUIDE.html" style="color: #1976d2; text-decoration: none;">📋 Руководство пользователя</a> - Полное руководство по использованию</li>
    <li><a href="html/manuals/TECHNICAL_DOCS.html" style="color: #1976d2; text-decoration: none;">🔧 Техническая документация</a> - Архитектура и API</li>
    <li><a href="html/manuals/API.html" style="color: #1976d2; text-decoration: none;">📊 API документация</a> - REST API и интеграции</li>
  </ul>
  
  <h4 style="color: #1976d2;">🌱 Агрономические рекомендации</h4>
  <ul style="margin: 10px 0; padding-left: 20px;">
    <li><a href="html/manuals/AGRO_RECOMMENDATIONS.html" style="color: #1976d2; text-decoration: none;">🌿 Агрономические рекомендации</a> - Рекомендации по культурам</li>
    <li><a href="html/manuals/COMPENSATION_GUIDE.html" style="color: #1976d2; text-decoration: none;">🔬 Руководство по компенсации</a> - Научные модели и калибровка</li>
  </ul>
</div>
