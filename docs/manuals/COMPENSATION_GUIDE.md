...
| EC_raw | 100 µS/cm | 8000 µS/cm | Компенсация не выполняется | Засоленные почвы требуют специальных моделей |
...
| EC_raw | 100 µS/cm | 8000 µS/cm | Засоленные почвы требуют специальных моделей |
