...
3. [📊 Карта регистров](#-карта-регистров)
4. [🔍 Примеры протокола](#-примеры-протокола)
5. [🔧 Схема подключения ESP32](#-схема-подключения-esp32)
6. [⚡ Оптимизация производительности](#-оптимизация-производительности)
7. [🐛 Отладка и диагностика](#-отладка-и-диагностика)
8. [🔒 Безопасность](#-безопасность)
9. [📋 Связанная документация](#-связанная-документация)
