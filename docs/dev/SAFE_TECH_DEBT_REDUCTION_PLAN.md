...
- [ ] **Улучшение валидации паролей** (требования к сложности)
...
1. **Средний приоритет:** Механизм смены паролей (2 дня)
2. **Средний приоритет:** Улучшение валидации паролей (1 день)
