# 🗒️ Tech-Debt Report — June 2025 (rev-13, 02-Jul)

| Area | Status | Evidence / Metric |
|------|:------:|-------------------|
| Code cleanliness | 🟡 | 0 clang-tidy warnings (**устранены**); IWYU: 0 циклов, 3 неиспользуемых include; дублирование: 10 уникальных дубликатов (score=100, 🟡 Medium). |
