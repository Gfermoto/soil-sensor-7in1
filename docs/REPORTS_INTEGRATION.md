...
Для получения дополнительной помощи обращайтесь к [документации проекта](../README.md) или создавайте [issue](https://github.com/Gfermoto/soil-sensor-7in1/issues). 