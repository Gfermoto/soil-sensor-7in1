...
## 🚀 **Новое в v2.4.3 - Стабилизация кода:**
- **Полное отключение авторизации:** Упрощенная архитектура без системы паролей
- **Очистка мертвого кода:** Удалены неиспользуемые функции авторизации
- **Устранение дублирования:** Логическое разделение настроек между страницами
- **Исправление багов:** Корректные вызовы всех функций интерфейса
...
- **Веб-интерфейс** - настройка и мониторинг через браузер (БЕЗ авторизации)
- **MQTT публикация** - отправка данных в брокер с дельта-фильтрацией
...
GPIO4        →   DE               →   Управление направлением
GPIO5        →   RE               →   Управление приемом
...
- **Flash:** 913KB (46.5%) - стабильное использование после очистки
- **RAM:** 53KB (16.4%) - оптимальное потребление памяти
- **Свободно для OTA:** 1.0MB+ (достаточно для partition + обновление)
- **Стабильность:** Упрощенная архитектура без авторизации
- **Архитектура:** Константы централизованы, код очищен от мертвых функций

## 🔧 Фильтрация и обработка данных

### 📊 **Скользящее среднее:**
- Размер окна: 5-15 измерений (настраивается)
- Алгоритм: среднее арифметическое или медиана
