...
## [3.2.20] - 2025-06-20 🧪 **TEST BUILD (OTA timeout)**

* Увеличен таймаут HTTP-клиента OTA до 65 000 мс, чтобы избежать обрывов загрузки на медленных CDN.
...
## [3.2.21] - 2025-06-20 🧪 **TEST BUILD 2 (longer download timeout)**

* Локальный таймаут в `downloadData()` увеличен до 120 000 мс (2 мин).
* Ожидается, что скачивание прошивки 1,2 МБ теперь завершится без разрыва.
