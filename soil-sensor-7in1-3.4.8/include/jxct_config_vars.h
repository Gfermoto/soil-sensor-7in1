...
// Перечисление условий выращивания
enum class GrowingCondition {
    OUTDOOR,
    GREENHOUSE,
    INDOOR,
    NONE
...
struct __attribute__((packed)) Config
{
    ...
    // Новые поля для культур и условий выращивания
    CropType cropType = CropType::NONE;
    GrowingCondition growingCondition = GrowingCondition::NONE;
};
