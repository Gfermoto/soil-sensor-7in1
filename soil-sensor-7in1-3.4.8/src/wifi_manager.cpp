...
void handleRoot()
{
    ...
    if (currentWiFiMode == WiFiMode::STA)
    {
        ...
        html += String("<option value='blueberry'") + (strcmp(config.cropId,"blueberry")==0?" selected":"") + ">Черника</option>";
        ...
        html += String("<option value='conifer'") + (strcmp(config.cropId,"conifer")==0?" selected":"") + ">Хвойные</option>";
        html += String("<option value='turfgrass'") + (strcmp(config.cropId,"turfgrass")==0?" selected":"") + ">Газонные травы</option>";
        html += "</select></div>";
        ...
        html += String("<option value='0'") + selectedEnvOutdoor + ">Открытый грунт (OUTDOOR)</option>";
        html += String("<option value='1'") + selectedEnvGreenhouse + ">Теплица (GREENHOUSE)</option>";
        html += String("<option value='2'") + selectedEnvIndoor + ">Закрытое помещение (INDOOR)</option></select></div>";
