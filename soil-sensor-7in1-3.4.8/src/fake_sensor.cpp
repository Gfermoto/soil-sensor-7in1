    ...
    for (;;)
    {
        ...
        if (iterationCounter >= dataGenerationInterval)
        {
            ...
            if (config.flags.calibrationEnabled)
            {
                ...
                sensorData.ec = correctEC(sensorData.ec,
                ...
                correctNPK(sensorData.temperature, sensorData.humidity, sensorData.nitrogen, sensorData.phosphorus, sensorData.potassium, soil, config.environmentType);
            }
